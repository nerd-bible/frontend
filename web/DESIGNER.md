...
- what should clicking logo do?
  - dashboard page?
- [x] how show/hide left panel
- [x] publisher vs user note style
  - text-decoration options:
    - [x] color
    - [x] style (solid, double, dotted, dashed, wavy)
...
- [x] allow light/dark theme?
  - limits user highlights colorspace
    - [x] can map 100 -> 900, 50 -> 950
